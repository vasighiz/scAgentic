...
\begin{titlepage}
    ...
    % Study information
    \Large\textbf{Not available}
    \vspace{0.5cm}

    % GEO accession
    \Large\textbf{GEO Accession: pbmc}
    \vspace{0.5cm}

    % Species and tissue
    \Large\textbf{Species: Not available}
    \vspace{0.5cm}
    \vspace{1cm}
...
\begin{itemize}
    \item \textbf{GEO Accession:} pbmc
    \item \textbf{Status:} Not available
    \item \textbf{Title:} Not available
    \item \textbf{Source Name:} Not available
    \item \textbf{Organism:} Not available
    \item \textbf{Analysis Date:} {April 12, 2025}
\end{itemize}

% Add a link to the GEO page
\begin{quote}
    \textbf{GEO Link:} \url{https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=pbmc}
\end{quote}
