...
Calculated quality control metrics and generated distribution plots for genes, counts, and mitochondrial content.
...
\subsection{7. UMAP Visualization}
Generated UMAP dimensionality reduction visualization of the dataset.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{umap.png}
    \caption{UMAP Visualization}
    \label{fig:umap}
\end{figure}
